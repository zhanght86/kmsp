 ...
 * 
 */
package com.yonyou.kms.modules.act.service.ext;
...
import com.yonyou.kms.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.yonyou.kms.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.yonyou.kms.modules.sys.entity.User(null, userId)))){
