...
//	private Integer sort; 		// 排序（升序）
    ...
    //add by luqibao
    private String isAdmin; //是否对这个只是分类具有操作权限 
    //end
    //huangmj 2015 12 31 start
    private String isExiteInsys_role_category;//知识分类是否在关联角色表中0：不存在，1存在
    //huangmj 2015 12 31 end
	...
	public Category(){
		...
		this.isExiteInsys_role_category = "0";
	}
	...
	public String getIsExiteInsys_role_category() {
		return isExiteInsys_role_category;
	}

	public void setIsExiteInsys_role_category(String isExiteInsys_role_category) {
		this.isExiteInsys_role_category = isExiteInsys_role_category;
	}
...
//	}
	...
	//add by luqibao 当知识分类下有知识或者是知识库下面有知识分类 
