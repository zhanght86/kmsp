...
//	private List<User> userList = Lists.newArrayList(); // 拥有用户列表
	...
	// 数据范围（1：所有数据；2：所在公司及以下数据；3：所在公司数据；4：所在部门及以下数据；5：所在部门数据；8：仅本人数据；9：按明细设置,10部门及以上,11公司及以上）
	...
	//add by luqibao
	public static final String DATA_SCOPE_OFFICE_ABOVE="10";
	public static final String DATA_SCOPE_COMPANY_ABOVE="11";
	//end
	private String isChecked="0";  //是否被选中 1为选中，0为不选中
