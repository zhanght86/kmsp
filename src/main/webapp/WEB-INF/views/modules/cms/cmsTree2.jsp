...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
		            <c:forEach items="${categoryList}" var="tpl">{id:'${tpl.id}', pId:'${not empty tpl.parent?tpl.parent.id:0}', name:"${tpl.name}", url:"${ctx}/cms/${not empty tpl.module?'comment':'none'}/?category.id=${tpl.id}", target:"cmsMainFrame"},
		            </c:forEach>];
...
<body>
	<div class="accordion-group">
	    <div class="accordion-heading">
	    	<a class="accordion-toggle">请选择类别</a>
	    </div>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			//$("#tree_1_a").click();
			//document.getElementById("tree_2_a").click();
		});
	</script>
</body>
</html>