...
<c:set var="ctx_f" value="${pageContext.request.contextPath}/f"/>
<c:set var="ctx_a" value="${pageContext.request.contextPath}/a"/>
...
<c:set var="index" value="${pageContext.request.contextPath}/static/index"/>
<c:set var="ctx" value="${pageContext.request.contextPath}/f"/>
