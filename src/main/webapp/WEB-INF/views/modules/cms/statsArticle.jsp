...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cms/stats/article">知识统计</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="article" action="${ctx}/cms/stats/article" method="post" class="breadcrumb form-search">
		<div>
			<label>归属知识库：</label><sys:treeselect id="category" name="categoryId" value="${paramMap.id}" labelName="categoryName" labelValue="${paramMap.name}"
				title="知识分类" url="/cms/category/treeData" module="article" cssClass="input-small" allowClear="true"/>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>父级知识库</th><th>知识分类名称</th><th>知识数</th><th>点击量</th><th>最后更新时间</th><th>归属机构</th>
		<tbody>
