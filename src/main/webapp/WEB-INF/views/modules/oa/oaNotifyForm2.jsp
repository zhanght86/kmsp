...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a>消息<shiro:hasPermission name="oa:oaNotify:edit">${oaNotify.status eq '1' ? '查看' : not empty oaNotify.id ? '修改' : '添加'}</shiro:hasPermission><shiro:lacksPermission name="oa:oaNotify:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline"><a href="${pageContext.request.contextPath}${fns:getFrontPath()}/view-${fnc:getArticlecid(oaNotify.remarks)}-${oaNotify.remarks}${fns:getUrlSuffix()}" target="_blank">查看此知识</a> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			...
			<a href="${ctx}/sys/user/userMessage"><input id="btnCancel" class="btn" type="button" value="返 回"/></a>
		</div>
	</form:form>
</body>
</html>