...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/oa/oaNotify/${oaNotify.self?'self':''}">按知识库统计</a></li>
	...
	<form:form id="searchForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/${oaNotify.self?'self':''}" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			<li><label>知识库：</label>
				<form:input type="datetime" id="time" name="time" path="title" htmlEscape="false" maxlength="200" class="input-medium"/>
