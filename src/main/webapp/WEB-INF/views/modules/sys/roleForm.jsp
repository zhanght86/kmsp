	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		隐藏是否系统数据--> 
		  <div class="control-group" style="display:none">
			<label class="control-label">管理类角色:</label>
			<div class="controls">
				...
				<span class="help-inline">“是”代表为管理类型的角色,“否代表的是数据类角色,(例如：技术类知识查看角色)”</span>
			</div>
		</div>
		...
		<div class="control-group" style="display:none">
			...
			<div class="controls">
				...
				<span class="help-inline">“当管理类角色选择‘否’时，本设置无效(按明细设置不可用)“</span>
			</div>
		</div> 
		<!--  <div class="control-group">
			<label class="control-label">角色授权:</label>  
			<div id="roleChangePower">
				<iframe frameborder=0 id="InroleChangePower" src="${pageContext.request.contextPath}/static/index/sysManage_roleChange.html"  scrolling="no"></iframe>
			</div>
			 -->
			<style>
			#roleChangePower{
