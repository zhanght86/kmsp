...
<body>
	<div id="assignRole" class="row-fluid span12">
		<div class="span6" style="border-right: 1px solid #A8A8A8;width:290px; height:320px;overflow:auto">
			<p>所在部门：</p>
			<div id="officeTree" class="ztree" style=""></div>
		</div>
		<div class="span2" style=" border-right: 1px solid #A8A8A8;width:140px; height:320px;overflow:auto"> 
			<p>待选人员：</p>
			<div id="userTree" class="ztree" ></div>
		</div>
		<div class="span3" style="width:120px; height:320px;overflow:auto " >
			<p>已选人员：</p>
